    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        messagePOJOReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot postSnapshot: dataSnapshot.getChildren()){
                    Messages task = postSnapshot.getValue(Messages.class);
                    al.add(new Messages(task.getText(), task.getTime(), task.getUser()));
                }
                MessagesAdapter aa = new MessagesAdapter(WebWeatherActivity.this, R.layout.row, al);
                lv.setAdapter(aa);
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Messages task = new Messages(etText.getText().toString(), time, name);
